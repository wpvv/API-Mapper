...
interface LowLevelParameterInterface {
    name: string,
    rows: object[],
    dataSources: object[]
}

export const LowLevelParameter: React.FC<LowLevelParameterInterface> = ({
                                                                            name,
                                                                            rows,
                                                                            dataSources
                                                                        }) => {
    ...
    return (
        <DataTable rows={rows} headers={headers}>
            {({
                ...
                <TableContainer title={name + " parameter mapping"}
...
export default LowLevelParameter